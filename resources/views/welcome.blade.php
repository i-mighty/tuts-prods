...
@section('content')
    ...
    <div id="home" class="hero-area">
        ...
        <!-- Backgound Image -->
        <div class="bg-image bg-parallax overlay" style="background-image:url({{URL::asset('/img/home-background.jpg')}})"></div>
        <!-- /Backgound Image -->
    ...
    <div id="cta" class="section">
        ...
        <!-- Backgound Image -->
        <div class="bg-image bg-parallax overlay" style="background-image:url({{URL::asset('/img/cta1-background.jpg')}})"></div>
        <!-- /Backgound Image -->
    ...
    <div id="contact-cta" class="section">
        ...
        <!-- Backgound Image -->
        <div class="bg-image bg-parallax overlay" style="background-image:url({{URL::asset('/img/cta2-background.jpg')}})"></div>
        <!-- Backgound Image -->
